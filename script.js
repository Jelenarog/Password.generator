...
function generatePassword() {
  ...
  ///var checked = null; // try if condition with null?
  ...
  var numberOfCharacters = function () {
    if (passwordLength < 8) {
      window.alert("Please choose number between 8 nad 128.")
    }
  ...
  //random index function to select random index from list of characters user wants to use
